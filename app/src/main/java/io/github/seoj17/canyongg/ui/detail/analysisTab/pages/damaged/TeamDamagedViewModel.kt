...
import io.github.seoj17.canyongg.ui.detail.analysisTab.pages.TeamDamagedFragmentArgs
...
class TeamDamagedViewModel @Inject constructor(
    ...
    private val matchId = TeamDamagedFragmentArgs.fromSavedStateHandle(savedStateHandle).matchId
