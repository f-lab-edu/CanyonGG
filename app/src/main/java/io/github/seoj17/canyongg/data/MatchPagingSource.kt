...
class MatchPagingSource(
...
) : PagingSource<Int, MatchesDataModel>() {
    override fun getRefreshKey(state: PagingState<Int, MatchesDataModel>): Int? {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, MatchesDataModel> {
        ...
        return LoadResult.Page(
            data = MatchesDataModel(localService.getMyMatchInfo(summonerPuuid)),
